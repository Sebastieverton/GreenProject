...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Sistema.enviarMensagemParaAlguem("Oi José","maria.barbosa@dcx.ufpb.br", true, "jose.silva@dcx.ufpb.br");
            Sistema.enviarMensagemParaTodos("Oi pessoal", "maria.barbosa@dcx.ufpb.br", true);
            for (Mensagem m : Sistema.pequisaMensagemAnonimas()){
                System.out.println(m.GetTextoCompletoAExibir());
            }
            String amigoSecreto =Sistema.pesquisarAmigoSecretoDaPessoa("jose.silva@dcx.ufpb.br");
            if(amigoSecreto.equals("maria.barbosa@dcx.ufpb.br")){
                System.out.println("OK");
            }

        }catch (JaFoiCadastradoException | FoiEnviadoExcption   | AmigoInexistenteException | AmigoNaoSorteadoException  e  ){
