...
public  class  TestaSistemaAmigo {
    private static Object AmigoJaExisteException;

    public static void principal(String[] args) throws JaFoiCadastradoException, AmigoInexistenteException, FoiEnviadoExcption {
        ...
        tente {
            ...
            for (Mensagem m : Sistema.pesquisaMensagensAnônimas()) {
                Sistema.fora.println(m.GetTextoCompletoAExibir());
            }
